    ...
    <footer className="w-full bg-[#f9f6e7] pt-0 pb-7 px-2 sm:px-4 select-none">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-center justify-between gap-8 md:gap-0">
        ...
        <div className="flex flex-col gap-1 font-blatant text-[15px] text-[#053126] min-w-[180px] items-center md:items-end order-3 md:order-3 w-full md:w-auto">
          ...
          <span className="text-[#A1B864] font-blatant text-sm mt-4">
            © {new Date().getFullYear()} Daylish. Tous droits réservés.
          </span>
        </div>
        {/* Logo Daylish */}
        <div className="flex flex-col items-center order-1 md:order-1">
          <Link href="/" aria-label="Accueil Daylish" className="flex-shrink-0 group md:mb-0">
